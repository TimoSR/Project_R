...
resource "google_cloud_run_service" "game-cms-service" {
  name     = "game-cms-service" # Replace with your desired service name.
  provider = google
  location = var.region
...
resource "google_service_account" "sa" {
  account_id   = "game-cms-pubsub-inv"  # Shortened to meet the character limit
  display_name = "GameCMS Pub/Sub Invoker"
...
resource "google_cloud_run_service_iam_binding" "binding" {
  location = google_cloud_run_service.game-cms-service.location
  service  = google_cloud_run_service.game-cms-service.name
  role     = "roles/run.invoker"
  members  = [
    "allUsers",
