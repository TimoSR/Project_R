...
using CommonLibrary.Application.Registrations.Events;
using CommonLibrary.Application.Registrations.GraphQL;
using CommonLibrary.Application.Registrations.Services;
using CommonLibrary.Application.Startup;
using CommonLibrary.Infrastructure.Middleware;
using CommonLibrary.Infrastructure.Persistence.Google_PubSub;
using CommonLibrary.Infrastructure.Persistence.MongoDB;
using CommonLibrary.Infrastructure.Persistence.Redis;
using CommonLibrary.Infrastructure.Registrations.Repositories;
using CommonLibrary.Infrastructure.Registrations.Utilities;
using CommonLibrary.Infrastructure.Swagger;
using CommonLibrary.Infrastructure.Utilities;
using CommonLibrary.Infrastructure.Utilities.Containers;
using IConfiguration = CommonLibrary.Infrastructure.Utilities._Interfaces.IConfiguration;
